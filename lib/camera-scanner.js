...
export class CameraScanner {
  ...
  /**
    ...
    *
    * @private
    * @returns {number} Minimum scan time in milliseconds.
    */
  _getMinScanTime() {
  ...
  /**
    ...
    *
    * @private
    * @returns {number} Interval in milliseconds between
    *  continuous scan attempts.
    */
  ...
  /**
    ...
    *
    * @param {HTMLElement} container - The DOM element that will
    *  contain the camera preview.
    * @returns {Promise<object>} Result object indicating success
    *  or failure, and camera/video status.
    */
  async start(container) {
    ...
    try {
      ...
      // Create camera stream with simple constraints
      ...
      // Container management - keep MRZ container update logic
  ...
  /**
    * Handle container setup - simplified version.
    *
    * @param container
    * @private
    */
  _handleContainerSetup(container) {
    ...
    if(this.config.scanType === 'mrz' &&
      ...
      // MRZ camera mode - update container reference for Dynamsoft native UI
  ...
  /**
    * Get simple camera constraints matching Iteration 0.
    *
    * @private
    */
  ...
  // ========================================
  // SCANNING METHODS - SIMPLE DELEGATES TO OPTICAL SCANNER
  // ========================================
  // These methods delegate to OpticalScanner's proven methods.
